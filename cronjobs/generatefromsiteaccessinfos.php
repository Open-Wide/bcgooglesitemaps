...
foreach ( $siteaccesses as $siteaccess )
{
     ...
     */
    $siteAccessContentINI = eZINI::instance( 'content.ini.append.php', 'settings/siteaccess/' . $siteaccess['siteaccess']  );
    $siteaccessRootNodeID = $siteAccessContentINI->variable( 'NodeSettings', 'RootNode' );

    $rootNode = eZContentObjectTreeNode::fetch( $siteaccessRootNodeID, $siteaccess['locale'] );
